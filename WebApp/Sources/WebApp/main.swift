        ...
        GeometryReader { proxy in
            ...
            .onAppear {
                ...
                if !self.isMobile {
                    ...
                    self.canvasSize = min(screenSize.width - 40 /*padding*/, maxHeight < 100 ? 999999 : maxHeight)
...
/// A ZStack that fits its contents (HTML)
///
/// For some reason, does not work
@available(*, deprecated, message: "Does not work")
fileprivate struct ZStackFit<Content>: View where Content: View {
    ...
    var body: some View {
        HTML(
            "div",
            ["style": "display: grid; grid-template-columns: 1fr; width: fit-content; justify-items: center; align-items: center; height: fit-content;"]
        ) {
            self.content
        }
    }
